...
| -------------------------------------- | -------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Kafka (native)                         | `list-topics`, `create-topics`, `delete-topics`, `produce-message`, `consume-messages` | Pass `cluster_id` + `environment_id` as arguments. Schema Registry serialization works on produce/consume for `AVRO`, `JSON`, and `PROTOBUF`. For `PROTOBUF` produce, also pass `messageName` (the fully-qualified message type, e.g. `com.example.User`) so the payload can be encoded against the right type. |
...
| -------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| (always on)                                              | `search-product-docs`, `get-product-doc-page`, `explain-disabled-tools`                                                                                                                                                                                                                                                                                      |
...
| `confluent_cloud` (direct only)                          | `list-connectors`, `get-connector-config`, `get-connector-offsets`, `get-connector-status`, `get-connector-tasks`, `delete-connector`, `pause-connector`, `resume-connector`, `restart-connector`, `update-connector-config`                                                                                                                                 |
