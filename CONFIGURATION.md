...
| -------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| (always on)                                              | `search-product-docs`, `get-product-doc-page`, `explain-disabled-tools`, `list-configured-connections`                                                                                                                                                                                                                                                       |
...
| `flink`                                                  | `create-flink-statement`, `list-flink-statements`, `read-flink-statement`, `delete-flink-statements`, `get-flink-statement-exceptions`, `check-flink-statement-health`, `detect-flink-statement-issues`, `list-flink-catalogs`, `list-flink-databases`, `list-flink-tables`, `describe-flink-table`                                                          |
