...
| **Flink SQL** ¹                              | `create-flink-statement`, `list-flink-statements`, `get-flink-statement-results`, `delete-flink-statements`, `get-flink-statement-exceptions`, `list-compute-pools`                                                                                                                                                                            | Create and manage Flink SQL statements                                                     |
