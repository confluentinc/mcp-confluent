...
| **Flink Catalog**                            | `list-flink-catalogs`, `list-flink-databases`, `list-flink-tables`, `describe-flink-table`                                                                                                                                                                                                                                                   | Explore Flink catalogs, databases, and table schemas                                       |
...
flink:
  ...
  describe-flink-table: Describe a Flink table: returns its full column schema (names, data types including $rowtime, nullability, metadata columns) together with table-level metadata (watermark configuration, distribution, and table type)...
